            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    ...
                    if(isset($_GET['activation_id'])){
                        ...
                        $query="UPDATE tbl_user SET activation='0' WHERE id='$activation_id'";
                        $result=database::connect()->query($query);
                        if($result){
                            echo "<p class='alert alert-success' ><strong>Success!</strong> Your user inactive success.</p>";
                        }
                    }
                        ...
                        if($result->num_rows>0) {
                            ...
                            foreach ($result as $value){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a onclick="return confirm('Are you sure to active this user?')" href="?activation_id=<?php echo  $value['id']; ?>" class="btn btn-success"><i class="glyphicon glyphicon-arrow-down"></i></a>
