...
?>
    ...
    <div class="content-wrapper">
        <section class="content-header"><h1> Profile</h1>
            <ol class="breadcrumb">
                ...
                <div class="col-md-2"></div>
                    <div class="col-md-8 table-responsive">
                        ...
                        if($_SERVER['REQUEST_METHOD']=="POST" && isset($_POST['update_btn'])){
                            $updateResult= $admin->updateProfile($_POST,$_FILES,$adminId);
                        }
                        if(isset($updateResult)){
                            echo $updateResult;
                        }
                        $query="SELECT * FROM tbl_admin WHERE id='$adminId'";
                ...
                <div class="col-md-8">
                    <div class="box table-responsive">
                        ...
                        if($_SERVER['REQUEST_METHOD']=="POST" && isset($_POST['update_pass'])){
                            $changePass= $admin->changePassword($_POST,$adminId);
                        }
                        if(isset($changePass)){
                            echo $changePass;
                        }
